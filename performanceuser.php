...
<html>
	...
	<body class="loggedin">
		...
		<div class="mt-3">
			<div class="container-fluid">
				<p>	A list of gardeners with performance from most to least: <br></p>
				<table class="table">
					<thead>
					<tr>
						<th scope="col">ID</th>
					...
					<?php
					$query = mysqli_query($con, "SELECT * FROM top_5_gardeners Where type_user='Gardener' ORDER by seed_harvest DESC LIMIT 5");
