...
if(isset($_POST['new']) && $_POST['new']==1) {
	...
	$status = "Purchased Quantity Successfully.";
...
if(isset($_POST['new']) && $_POST['new']==1) {
	$quantity=$_REQUEST['quantity'];
	//$quantity1=$_REQUEST['quantity1'];
	$update = "UPDATE seeds_inventory SET purchase_date = '".$date."' where seed_id='".$seed_number."'";
...
<html>
	...
	<body class="loggedin">
		...
		<div class="content">
			<h2>Add Purchase Page</h2>
			<div>
				<p>Add Purchased Quantity:</p>
