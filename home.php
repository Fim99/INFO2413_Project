...
<html>
	...
	<body class="loggedin">
		...
		<div class="container mt-2">
				<p class="text-center">Welcome back, <b><?=$_SESSION['username']?></b>! <br> <?php echo "Today's Date: " . date("d-M-Y"); ?></p>
		</div>
		
		<div class="container justify-content-center">
			<div class="card">
			  <img src="https://images.unsplash.com/photo-1560493676-04071c5f467b?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1974&q=80" 
				   class="card-img-top" alt="..." style="height:75vh;">
			</div>					
		</div>
